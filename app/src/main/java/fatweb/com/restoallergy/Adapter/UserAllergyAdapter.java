...
public class UserAllergyAdapter extends RecyclerView.Adapter<UserAllergyAdapter.PostViewHolder> {

    private List<Allergy> allergyList;
    private Context context;

    public UserAllergyAdapter(List<Allergy> allergyList, Context context) {
    ...
    public PostViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_allergy, viewGroup, false);
