...
public class UserAllergyIconAdapter1 extends RecyclerView.Adapter<UserAllergyIconAdapter1.PostViewHolder> {

    private List<Allergy> allergyList;
    private Context context;

    public UserAllergyIconAdapter1(List<Allergy> allergyList, Context context) {
    ...
    public void onBindViewHolder(final PostViewHolder postViewHolder,final int position) {
        ...
        Glide.with(context).load(image).apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).placeholder(R.drawable.applogo1).dontAnimate().override(30, 30).timeout(60000)).into(postViewHolder.ivIcon);
