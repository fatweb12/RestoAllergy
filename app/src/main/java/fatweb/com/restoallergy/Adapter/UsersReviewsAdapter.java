...
public class UsersReviewsAdapter extends RecyclerView.Adapter<UsersReviewsAdapter.PostViewHolder> {
    ...
    public UsersReviewsAdapter(List<RestaurantRatingReview> list, UsersReviewsListener listener, Context context, Boolean showEdit) {
        this.list = list;
    ...
    public void onBindViewHolder(final PostViewHolder postViewHolder,final int position) {
       ...
       // postViewHolder.tvRatingid.setText(item.restaurant_info.rating_user_id);

        postViewHolder.tvRatingid.setText(item.restaurant_info.rating_user_id);
       // postViewHolder.tvRatingid1.setText(item.ratings.ratings);
...
//                                .show();
    ...
    public  class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        protected TextView tvUser,tvDateAdded,tvDetails,tvRatingid,tvRatingid1;
